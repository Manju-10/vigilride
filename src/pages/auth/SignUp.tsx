...
const SignUp = () => {
  ...
  const handleSignUp = (e: React.FormEvent) => {
    ...
    // Mark as new user, then navigate to complete profile
    ...
    <div className="min-h-screen bg-gradient-primary flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-md animate-slide-up">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-white/70">Join VigilRide and secure your vehicle</p>
        </div>
        ...
        <div className="glass rounded-3xl p-8 shadow-elevated">
          <form onSubmit={handleSignUp} className="space-y-5">
            <div>
              <Label htmlFor="name" className="text-white/90 mb-2 block">Full Name</Label>
            ...
            <div>
              <Label htmlFor="password" className="text-white/90 mb-2 block">Create Password</Label>
              <div className="relative">
            ...
            <div className="flex items-start gap-2">
              ...
              <Label htmlFor="terms" className="text-white/80 text-sm leading-relaxed cursor-pointer">
                I agree to the{" "}
                <span className="text-accent hover:text-accent/80">Terms & Conditions</span>
                {" "}and{" "}
            ...
            <Button
              type="submit"
              className="w-full h-12 bg-success hover:bg-success/90 text-foreground font-semibold rounded-xl shadow-lg glow-success transition-smooth"
            >
              Create Account
            </Button>
          </form>
          ...
          <div className="mt-6 text-center">
            <p className="text-white/70 text-sm">
              ...
              <Link to="/signin" className="text-accent hover:text-accent/80 font-semibold transition-smooth">
                Sign In
              </Link>
            </p>
          </div>
